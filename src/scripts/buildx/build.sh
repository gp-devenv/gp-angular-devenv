...
IMAGE="$IMAGE_NAME:$1-$2-$3"
IMAGE_VERSION="$IMAGE_NAME:$1-$2-$3-$VERSION"
IMAGE_VERSION_MAJOR="$IMAGE_NAME:$1-$2-$3-$VERSION_MAJOR"
IMAGE_VERSION_MINOR="$IMAGE_NAME:$1-$2-$3-$VERSION_MINOR"
